...
<body>
    ...
    ?>
        <form class="formulario" method="post" action="../database/atualizar-filme.php">
            <input type="hidden" name="idFilme" id="idFilme" value="<?php echo $value['idFilme']; ?>">
            <div class="row mb-3">
                <label class="col-sm-0 col-form label"><strong>Titulo:</strong></label>
                <div class="col-sm-12">
                    <input type="text" class="form-control" name="titulo"  id="titulo" maxlength="40" autocomplete="off" value="<?php echo $value['Titulo']; ?>">
                </div>
            </div>
            <div class="group1">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="duração" id="duração" autocomplete="off" value="<?php echo $value['Duração']; ?>">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-z col-form label"><strong>Ano:</strong></label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="ano" id="ano" placeholder="Ex: 2022" autocomplete="off" value="<?php echo $value['Ano']; ?>">
                    </div>
                </div>
                <div class="col-3">
            ...
            <div class="group1">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="genero" id="genero" value="<?php echo $value['Genero']; ?>" autocomplete="off">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-0 col-form label"><strong>Diretor:</strong></label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="diretor" id="diretor" value="<?php echo $value['Diretor']; ?>" autocomplete="off">
                    </div>
                </div>
                <div class="col-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-12">
                    <input type="text" class="form-control" name="banner" id="banner" value="<?php echo $value['Banner']; ?>" autocomplete="off">
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-sm-0 col-form label"><strong>Sinopse:</strong></label>
                <div class="col-sm-12">
                    <textarea class="form-control" name="sinopse" id="sinopse" cols="30" rows="5"><?php echo $value['Sinopse']; ?></textarea>
                </div>
            </div>
            <div class="col d-flex justify-content-center">
                <div class="buttons">
