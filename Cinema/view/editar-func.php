...
<body>
    ...
    <?php
        ...
        $value = $func->buscar($id);
    ?>
        <form class="formulario" method="post" action="../database/atualizar-func.php">
        <input type="hidden" name="idFuncionário" id="idFuncionário" value="<?php echo $value['idFuncionário']; ?>">
            <div class="row mb-3">
                <label class="col-sm-0 col-form label"><strong>Nome:</strong></label>
                <div class="col-sm-12">
                    <input type="text" class="form-control" name="nome" value="<?php echo $value['Nome']; ?>" maxlength="40" placeholder="Ex: José Paulo Costa" autocomplete="off">
                </div>
            </div>
            <div class="group1">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="cpf" value="<?php echo $value['CPF']; ?>" placeholder="123.456.789-00" autocomplete="off">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-0 col-form label"><strong>Cargo:</strong></label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="cargo"  value="<?php echo $value['Cargo']; ?>" placeholder="Ex: Atendente" autocomplete="off">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-0 col-form label"><strong>Salário:</strong></label>
                    <div class="col-sm-12">
                        <input type="number" class="form-control" name="salario"  value="<?php echo $value['Salário']; ?>" placeholder="Ex: 1.200" autocomplete="off">
                    </div>
                </div>
            </div>
            <div class="group1">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-11">
                        <input type="text" class="form-control" name="endereco"  value="<?php echo $value['Endereço']; ?>" placeholder="Ex: Vila Paraiso, Q12, N 45" autocomplete="off">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-0 col-form label"><strong>Telefone:</strong></label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="telefone"  value="<?php echo $value['Telefone']; ?>" placeholder="Ex: (99) 98888-8888" autocomplete="off">
                    </div>
                </div>
                <div class="col-5">
