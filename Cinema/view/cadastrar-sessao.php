...
<body>
    ...
    <div class="col d-flex justify-content-center">
        <form class="formulario" method="post" action="../database/inserir-sessao.php">
            <div class="group1">
                <div class="row mb-3">
                    <label class="col-sm-0 col-form label"><strong>Data:</strong></label>
                    <div class="col-sm-10">
                        <input type="date" class="form-control" name="dataSessao" placeholder="aa/mm/dd" autocomplete="off">
                    </div>
                </div>
                <div class="row mb-3">
                    <label class="col-sm-0 col-form label"><strong>Horário:</strong></label>
                    <div class="col-sm-10">
                        <input type="time" class="form-control" name="horário" placeholder="Ex: 16:45" autocomplete="off">
                    </div>
                </div>
                <div class="col-3">
